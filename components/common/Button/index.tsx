...
const Button = ({
    ...
    const commonClasses = `inline-block rounded flex items-center gap-2 border border-transparent focus:outline-none focus:ring-4 transition-colors`
    const Variants = {
    ...
    return (
        <button
        className={cx(commonClasses, Variants[variant], Sizes[size])}
